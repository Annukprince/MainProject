...
//    @CrossOrigin(origins = "http://localhost:4200")
    ...
    @GetMapping("/routes")
//    @CrossOrigin(origins = "http://localhost:4200")
    public List<Bus> getBusesByRoutePattern(@RequestParam String startRoute, @RequestParam String endRoute) {
        return busService.getBusesByRoutePattern(startRoute, endRoute);
    }
}
